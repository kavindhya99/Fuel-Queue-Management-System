            ...
            case "Y":
                ...
                if ((length1 < length2) && (length1 < length3)&&(length1<length4)&&(length1<length5)) {
                    ...
                    while (five <= 5) {
                        Passenger obj6 = new Passenger();
                        obj6.adding();
                        queue5[five][0] = obj6.getCname();
                        queue5[five][1] = obj6.getCname2();
                        queue5[five][2] = obj6.getCname3();
                        queue5[five][3] = obj6.getCname4();
                        tot5 = tot5 +Integer.parseInt(queue5[five][3]) ;
                        System.out.println(obj6.getCname() + " is successfully added to Queue5" + " " + "\t\t\tTotal Liters= " + tot5);
                        if (five == 5) {
                            System.out.println("Queue 5 is full");
